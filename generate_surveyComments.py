...
# comment: need to change this to add another file for the question template
# constQTemp vs constQNATemp
...
import cv2
def draw_NA_square(img, R): # only call this function if you want to draw the N/A square
